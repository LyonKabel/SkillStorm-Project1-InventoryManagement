        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
            ...
            <main className="max-w-7xl mx-auto px-4 py-12">
                <section className="text-center mb-12">
                    <h2 className="text-4xl font-bold text-gray-800 mb-4">Clothing Inventory Management</h2>
                    <p className="text-2xl text-gray-600">The best way to make sure you keep track of your shirts!</p>
                </section>
